...
class LevelExport implements WithMapping, Responsable, WithHeadings, FromCollection, WithEvents, ShouldAutoSize
{
    use Exportable;
    ...
    public function collection()
    {
        ...
        return Level::query()->with(['year'])->search($request)->latest()->get();
    }
